...
public class CharacterControllerPushRigidBody : MonoBehaviour
{
    ...
    void OnControllerColliderHit(ControllerColliderHit hit)
    {
        ...
        //force = hit.controller.gameObject.transform.forward * pushPower * Time.deltaTime * hit.controller.;
        body.velocity += hit.controller.gameObject.transform.forward * 5f * Time.deltaTime;
        // Apply the push
        ...
        Debug.Log("vel: " + hit.controller.velocity.ToString());
